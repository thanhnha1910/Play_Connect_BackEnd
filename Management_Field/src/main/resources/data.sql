...
(N'District 12 Arena', N'35/6 TTH15 Street, Group 30, Quarter 3A, Tan Thoi Hiep Ward, District 12, Ho Chi Minh City', 10.8528, 106.6315, 1, 'district-12-arena'),
(N'Tan Thoi Hiep Pitch', N'35/6 TTH15 Street, Group 30, Quarter 3A, Tan Thoi Hiep Ward, District 12, Ho Chi Minh City', 10.8522, 106.6309, 1, 'tan-thoi-hiep-pitch'),
(N'Quarter 3A Sports Complex', N'35/6 TTH15 Street, Group 30, Quarter 3A, Tan Thoi Hiep Ward, District 12, Ho Chi Minh City', 10.8531, 106.6318, 1, 'quarter-3a-sports-complex'),
...
(N'An Phu Dong Premier Fields', N'35/6 TTH15 Street, Group 30, Quarter 3A, Tan Thoi Hiep Ward, District 12, Ho Chi Minh City', 10.8535, 106.6321, 1, 'an-phu-dong-premier-fields'),
(N'Hiep Thanh Athletics Club', N'35/6 TTH15 Street, Group 30, Quarter 3A, Tan Thoi Hiep Ward, District 12, Ho Chi Minh City', 10.8520, 106.6314, 1, 'hiep-thanh-athletics-club');
-- =================================================================
...
FROM locations
UNION ALL
SELECT 'field_types' as table_name,
       COUNT(*)      as total_records
FROM field_types
UNION ALL
SELECT 'field_categories' as table_name,
       COUNT(*)           as total_records
