...
public class PayPalPaymentService {
    ...
    public PayPalOrderCreationResponse initiatePayPalPayment(Long paymentId, float amount, String clientType) {
        ...
        String returnUrl = String.format("http://10.0.2.2:1444/api/payment/paypal/callback?paymentId=%d", paymentId);
        String cancelUrl = String.format("http://10.0.2.2:1444/api/payment/paypal/cancel?paymentId=%d", paymentId);
