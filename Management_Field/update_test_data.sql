...
DELETE FROM open_matches WHERE creator_user_id = 14;
DELETE FROM bookings WHERE user_id = 14;
...
-- Create open matches with Vietnamese tags
...
PRINT 'Test data updated with Vietnamese tags successfully';